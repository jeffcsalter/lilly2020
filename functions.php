...
if ( ! function_exists( 'lilly2020_setup' ) ) :
	/**
	...
	function lilly2020_setup() {
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'lilly2020' ),
			)
		);
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'lilly2020_custom_background_args',
				array(
 ...
 */
function lilly2020_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'lilly2020_content_width', 640 );
}
add_action( 'after_setup_theme', 'lilly2020_content_width', 0 );
 ...
 */
function lilly2020_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'lilly2020' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'lilly2020' ),
...
add_action( 'wp_enqueue_scripts', 'lilly2020_scripts' );
