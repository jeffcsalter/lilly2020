...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'lilly2020' ); ?></a>
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$lilly2020_description = get_bloginfo( 'description', 'display' );
			if ( $lilly2020_description || is_customize_preview() ) :
				?>
